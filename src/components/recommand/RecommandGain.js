		...
		return (
			<>
				...
				<div className="recommand_gain_wrapper">
					<img src="#" />
					<span>PP(PentaPlant)는 추천인(레퍼럴코드)이 없으면 가입이 불가능합니다.</span>
					<span>내가 온라인과 오프라인 등으로 추천한 추천인이 거래량(코인거래)을</span>
					<span>발생시키게 되면, 나와 나의 하부에서 발생하는 모든 거래자그룹 내에서</span>
					<span>최대 거래 수수료의 (40%)를 보너스로 공유받게 됩니다.</span>

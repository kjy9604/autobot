									...
									<table>
										...
										<tbody>
											<tr>
												...
												<td>일반회원</td>
												<td>일반회원</td>
												<td><span className="red_text">IB만</span></td>
												<td><span className="red_text">IB만</span></td>
											</tr>
										</tbody>
									</table>
									...
									<table>
										...
										<tbody>
											<tr>
												<td>없음</td>
												<td>없음</td>
												<td><span className="red_text">하위 회원의 실적 3% x 5회</span></td>
												<td><span className="red_text">하위 회원의 실적 2% x 5회</span></td>
												<td><span className="red_text">하위 회원의 실적 2% x 5회</span></td>
												<td><span className="red_text">하위 회원의 실적 1% x 5회</span></td>
											</tr>
										</tbody>
									</table>
									<br />
									<div className="reward_text">
										<span className="red_text">* 직접 혹은 간접적으로 파생된 회원들의 거래실적의 40%를 지급받는다.</span> <br />
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>X</td>
									<td>X</td>
									<td>작은라인쪽 회원 1레벨 두명</td>
									<td>X</td>
									<td>큰그룹제외 나머지그룹 총 디파짓 금액 15,000$ 이상</td>
									<td>작은라인쪽 회원 2레벨 두명</td>
									<td>X</td>
									<td>큰그룹제외 나머지그룹 총 디파짓 금액 90,000$ 이상</td>
									<td>작은라인쪽 회원 3레벨 두명</td>
									<td>X</td>
									<td>큰그룹제외 나머지그룹 총 디파짓 금액 360,000$ 이상</td>
									<td>작은라인쪽 회원 4레벨 한명</td>
									<td>X</td>
									<td>큰그룹제외 나머지그룹 총 디파짓 금액 450,000$ 이상</td>
								</tr>
								<tr>
									<th>그룹 인센티브 40%</th>
									<td>X</td>
									<td>X</td>
									<td colSpan="3">하위 회원의 실적 3% * 5회 <br/>(총 15%)</td>
									<td colSpan="3">하위 회원의 실적 2% * 5회 <br/>(총 10%)</td>
									<td colSpan="3">하위 회원의 실적 2% * 5회 <br/>(총 10%)</td>
									<td colSpan="3">하위 회원의 실적 1% * 5회 <br/>(총 5%)</td>
								</tr>
							</tbody>
						</table>
						<p>
							· 레벨업은 <span className="red_text">매월</span> 평가해서 상위레벨로 승급한다. <br />
							· 레벨다운은 <span className="red_text">매월</span> 평가하여 레벨유지 또는 강등한다. <br />
							· 3번 페이지와 4번 페이지의 레벨 승급 조건은 and 형태가 아닌 or 형태로 가능합니다.
						</p>
					</div>
